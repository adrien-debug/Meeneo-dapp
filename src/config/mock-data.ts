...
export const CONSERVATIVE_VAULT: VaultConfig = {
  ...
  name: 'Hearst 02',
  description:
    'Capital preservation focus — 60% USDC Yield, 25% BTC Hedged, 15% RWA Mining. ~5–9% annual yield distributed monthly. Withdraw at 36% target or 3 years.',
  ...
  strategies: [
    {
      ...
      color: '#9EB3A8',
      description:
        'Heavy USDC allocation for maximum capital safety with institutional lending protocols.',
    },
    {
      type: 'btc_hedged',
      label: 'BTC Hedged',
    ...
    },
    {
      ...
      color: '#96EA7A',
      description:
        'Minimal mining exposure for yield boost while keeping overall risk profile low.',
    },
  ],
  lockPeriodMonths: 36,
  yieldCliffMonths: 12,
  ...
  tvlCap: 30_000_000,
  currentTvl: 8_200_000,
  totalShares: 8_050_000,
  depositToken: 'USDC',
  chainId: 8453,
  status: 'active',
  minDeposit: 250,
...
export const AGGRESSIVE_VAULT: VaultConfig = {
  ...
  name: 'Hearst 03',
  description:
    'Maximum yield — 55% RWA Mining, 30% BTC Hedged, 15% USDC Yield. ~12–20% annual yield distributed monthly. Withdraw at 36% target or 3 years.',
  ...
  strategies: [
    {
      ...
      color: '#96EA7A',
      description:
        'Maximum mining allocation with premium ASIC fleet and strategic energy partnerships.',
    },
    {
      type: 'btc_hedged',
      label: 'BTC Hedged',
      ...
      color: '#5B7A6E',
      description:
        'Aggressive BTC delta strategies with higher leverage and options-based yield amplification.',
    },
    {
      type: 'usdc_yield',
      label: 'USDC Yield',
  ...
  tvlCap: 20_000_000,
  currentTvl: 5_640_000,
  totalShares: 5_400_000,
  depositToken: 'USDC',
  chainId: 8453,
  status: 'active',
  minDeposit: 1000,
...
export const MOCK_USER_DEPOSITS: UserDeposit[] = [
  ...
  {
    id: 2,
    vaultSlug: 'conservative-vault',
    amount: 800_000,
    depositTimestamp: NOW - 14 * MONTH,
    maturityTimestamp: NOW - 14 * MONTH + 3 * YEAR,
  ...
  {
    id: 3,
    vaultSlug: 'aggressive-vault',
    amount: 400_000,
    depositTimestamp: NOW - 38 * MONTH,
    maturityTimestamp: NOW - 38 * MONTH + 3 * YEAR,
    yieldCliffTimestamp: NOW - 38 * MONTH + YEAR,
    claimedYield: 144_000,
    pendingYield: 0,
    lockStatus: 'matured',
    progressPercent: 100,
  },
...
export const MOCK_VAULT_ACTIVITY: VaultActivity[] = [
...

  {
    ...
    type: 'rebalance',
    timestamp: NOW - 3 * DAY,
    description: 'USDC Yield 62% → 60%, BTC Hedged 23% → 25%',
    vaultSlug: 'conservative-vault',
  },
  {
    id: 'a-7',
    ...
    description: 'Yield distributed: $12,000',
    vaultSlug: 'conservative-vault',
  },
  {
    id: 'a-8',
    ...
    description: 'RWA Mining 17% → 15%, USDC Yield 58% → 60%',
    vaultSlug: 'conservative-vault',
  },
  {
    id: 'a-9',
    ...
    description: 'Yield distributed: $8,400',
    vaultSlug: 'conservative-vault',
  },

  {
    ...
    type: 'rebalance',
    timestamp: NOW - 4 * DAY,
    description: 'RWA Mining 53% → 55%, BTC Hedged 32% → 30%',
    vaultSlug: 'aggressive-vault',
  },
  {
    id: 'a-11',
    ...
    description: 'Yield distributed: $6,000',
    vaultSlug: 'aggressive-vault',
  },
  {
    id: 'a-12',
    ...
    description: 'BTC Hedged 28% → 30%, USDC Yield 17% → 15%',
    vaultSlug: 'aggressive-vault',
  },
]
