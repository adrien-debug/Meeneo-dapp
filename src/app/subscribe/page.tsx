                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-caption font-semibold px-2 py-0.5 rounded-full bg-[#96EA7A]/15 text-[#96EA7A]">
                        Active
                      </span>
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
            ...
            <div className={`${CARD} p-6 flex flex-col`}>
              ...
              <p className="text-xs text-[#9EB3A8] leading-relaxed mb-4">
                ...
                <span className="text-[#0E0F0F] font-semibold">bear, base & bull</span> scenarios
                over 36 months with our advanced analytics engine.
              </p>
              ...
              {step === 'confirm' && (
                <>
                  ...
                  <div className="flex items-center gap-3 p-4 bg-[#F2F2F2] rounded-xl mb-5">
                    ...
                    <p className="ml-auto text-xl font-black text-[#0E0F0F]">
                      {fmtUsd(parsedAmount)}
                    </p>
                  </div>
